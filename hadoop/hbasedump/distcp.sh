...
function distcp(){
  ...
  echo "command is:hadoop distcp hftp://$src:50070/export/modfiy/$1  webhdfs://$des:50070/move/import/$1				     "	>>$logfile
  hadoop distcp hftp://$src:50070/move/import/$1  webhdfs://$des:50070/move/import/$1 
